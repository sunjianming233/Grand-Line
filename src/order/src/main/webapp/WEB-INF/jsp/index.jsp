        ...
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree"  lay-shrink="all" id="lm">
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" id="2" onclick="showTab(1,'courselist.html','专业列表')">&nbsp;&nbsp;&nbsp;&nbsp;专业列表</a></dd>
                        <dd><a href="javascript:;" id="2" onclick="showTab(2,'courseadd.html','专业新增')">&nbsp;&nbsp;&nbsp;&nbsp;专业新增</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
                    <a href="javascript:;" id="1"><i class="fa fa-cube"></i>&nbsp;班级管理</a>
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" id="2" onclick="showTab(1,'gradelist.html','班级列表')">&nbsp;&nbsp;&nbsp;&nbsp;班级列表</a></dd>
                        <dd><a href="javascript:;" id="2" onclick="showTab(2,'gradeadd.html','班级新增')">&nbsp;&nbsp;&nbsp;&nbsp;班级新增</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
                    <a href="javascript:;" id="1"><i class="fa fa-user-secret"></i>&nbsp;学生管理</a>
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" id="2" onclick="showTab(1,'studentlist.html','学生列表')">&nbsp;&nbsp;&nbsp;&nbsp;学生列表</a></dd>
                        <dd><a href="javascript:;" id="2" onclick="showTab(2,'studentadd.html','学生新增')">&nbsp;&nbsp;&nbsp;&nbsp;学生新增</a></dd>
                        <dd><a href="javascript:;" id="2" onclick="showTab(3,'studentbatch.html','学生导入')">&nbsp;&nbsp;&nbsp;&nbsp;学生导入</a></dd>
                    </dl>
                </li>
