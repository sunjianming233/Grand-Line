		...
		<div class="col-md-9 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" class="active"><a href="#commentListPanel" aria-controls="commentListPanel" role="tab" data-toggle="tab">影评列表</a></li>
			    	<li role="presentation" ><a href="<%=basePath %>Comment/comment_frontAdd.jsp" style="display:none;">添加影评</a></li>
				</ul>
			  	<!-- Tab panes -->
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>影评id</td><td>电影</td><td>影评内容</td><td>评论用户</td><td>评论时间</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
				    	            		...
				    	            		for(int i=0;i<commentList.size();i++) {
					    	            		...
					    	            		Comment comment = commentList.get(i); //获取到影评对象
 										%>
 										<tr>
 											<td><%=currentIndex %></td>
 											<td><%=comment.getCommentId() %></td>
 											<td><%=comment.getMovieObj().getMovieName() %></td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="fa fa-edit"></i>&nbsp;影评信息编辑</h4>
      </div>
