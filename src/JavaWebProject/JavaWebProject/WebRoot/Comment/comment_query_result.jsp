...
<div id="commentEditDiv">
	<form id="commentEditForm" enctype="multipart/form-data"  method="post">
		...
		<div>
			...
			<span class="inputControl">
				<input class="textbox"  id="comment_movieObj_movieId_edit" name="comment.movieObj.movieId" style="width: auto"/>
			</span>
		</div>
		<div>
			<span class="label">影评内容:</span>
			<span class="inputControl">
				<input class="textbox" type="text" id="comment_content_edit" name="comment.content" style="width:200px" />
