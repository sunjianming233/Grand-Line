...
<div class="container">
	<ul class="breadcrumb">
  		...
  		<li><a href="<%=basePath %>Comment/frontlist">影评信息</a></li>
  		<li class="active">详情查看</li>
	</ul>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">影评id:</div>
		<div class="col-md-10 col-xs-6"><%=comment.getCommentId()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">电影:</div>
		<div class="col-md-10 col-xs-6"><%=comment.getMovieObj().getMovieName() %></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">影评内容:</div>
