		       ...
		       text: "影厅管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "MovieHall/movieHall_add.jsp"
			    	   	},
			    		{
			    	   		text: "影厅管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "MovieHall/movieHall_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "影片管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Movie/movie_add.jsp"
			    	   	},
			    		{
			    	   		text: "影片管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Movie/movie_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "档期计划管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Schedule/schedule_add.jsp"
			    	   	},
			    		{
			    	   		text: "档期计划管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Schedule/schedule_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "订票管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "MovieOrder/movieOrder_add.jsp"
			    	   	},
			    		{
			    	   		text: "订票管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "MovieOrder/movieOrder_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "影评管理",
