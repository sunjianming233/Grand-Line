          ...
          <a href="#">
            <div class="media">
              ...
              <div class="media-body">
                <h4 class="media-heading">精品电影推荐</h4>
                <p>此电影已经通过上演</p>
              </div>
            </div>
          </a>
        ...
        <div class="col-xs-6 col-md-4">
          <a href="#">
            <div class="media">
              ...
              <div class="media-body">
                <h4 class="media-heading">精品设电影推荐</h4>
                <p>此电影已经通过了上演</p>
              </div>
            </div>
          </a>
        ...
        <div class="col-xs-6 col-md-4">
          <a href="#">
            <div class="media">
              ...
              <div class="media-body">
                <h4 class="media-heading">精品电影推荐作</h4>
                <p>此电影已经通过了上演</p>
              </div>
            </div>
          </a>
        ...
        <div class="col-xs-6 col-md-4">
          <a href="#">
            <div class="media">
              ...
              <div class="media-body">
                <h4 class="media-heading">大数据电影推荐系统</h4>
                <p>此电影已经通过上演</p>
              </div>
            </div>
          </a>
