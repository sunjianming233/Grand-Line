...
<div class="container">
	...
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">用户电话:</div>
	...
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">用户类型:</div>
		<div class="col-md-10 col-xs-6"><%=userInfo.getUserType()%></div>
	</div>
	<div class="row bottom15"> 
