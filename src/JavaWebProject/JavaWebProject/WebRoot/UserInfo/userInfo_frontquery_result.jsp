...
<%
    ...
    String telephone = (String)request.getAttribute("telephone"); //用户电话查询关键字
    String userType = (String)request.getAttribute("userType"); //用户类型查询关键字
			...
			<div class="col-md-3 bottom15" <%=clearLeft %>>
			  <a  href="<%=basePath  %>UserInfo/<%=userInfo.getUser_name() %>/frontshow"><img class="img-responsive" src="<%=basePath%><%=userInfo.getUserPhoto()%>" /></a>
			     <div class="showFields">
			     	...
			     	<div class="field">
	            		用户电话:<%=userInfo.getTelephone() %>
			     	</div>
			     	<div class="field">
	            		家庭地址:<%=userInfo.getAddress() %>
			     	</div>
			     	<div class="field">
	            		用户类型:<%=userInfo.getUserType() %>
			     	</div>
			     	<div class="field">
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="userInfoQueryForm" id="userInfoQueryForm" action="<%=basePath %>UserInfo/frontlist" class="mar_t15" method="post">
			...
			<div class="form-group">
				...
				<input type="text" id="telephone" name="telephone" value="<%=telephone %>" class="form-control" placeholder="请输入用户电话">
			</div>
			<div class="form-group">
				<label for="userType">用户类型:</label>
				<input type="text" id="userType" name="userType" value="<%=userType %>" class="form-control" placeholder="请输入用户类型">
			</div>
			<div class="form-group">
				<label for="regTime">注册时间:</label>
				<input type="text" id="regTime" name="regTime" value="<%=regTime %>" class="form-control" placeholder="请输入注册时间">
			</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="userInfo_telephone_edit" class="col-md-3 text-right">用户电话:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="userInfo_telephone_edit" name="userInfo.telephone" class="form-control" placeholder="请输入用户电话">
			 </div>
		  </div>
		  <div class="form-group">
		  ...
		  <div class="form-group">
		  	 <label for="userInfo_userType_edit" class="col-md-3 text-right">用户类型:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="userInfo_userType_edit" name="userInfo.userType" class="form-control" placeholder="请输入用户类型">
			 </div>
		  </div>
		  <div class="form-group">
	...
	$.ajax({
		...
		success : function (userInfo, response, status) {
			if (userInfo) {
				...
				$("#userInfo_userType_edit").val(userInfo.userType);
