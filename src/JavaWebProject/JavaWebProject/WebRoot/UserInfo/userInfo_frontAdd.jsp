	...
	<div class="col-md-12 wow fadeInLeft">
		...
		<div class="row">
			<div class="col-md-10">
				  ...
				  <div class="form-group">
				  	 <label for="userInfo_telephone" class="col-md-2 text-right">用户电话:</label>
				  	 <div class="col-md-8">
					    <input type="text" id="userInfo_telephone" name="userInfo.telephone" class="form-control" placeholder="请输入用户电话">
					 </div>
				  </div>
				  <div class="form-group">
				  ...
				  <div class="form-group">
				  	 <label for="userInfo_userType" class="col-md-2 text-right">用户类型:</label>
				  	 <div class="col-md-8">
					    <input type="text" id="userInfo_userType" name="userInfo.userType" class="form-control" placeholder="请输入用户类型">
					 </div>
				  </div>
				  <div class="form-group">
				  	 <label for="userInfo_regTime" class="col-md-2 text-right">注册时间:</label>
				  	 <div class="col-md-8">
					    <input type="text" id="userInfo_regTime" name="userInfo.regTime" class="form-control" placeholder="请输入注册时间">
					 </div>
				  </div>
		          <div class="form-group">
